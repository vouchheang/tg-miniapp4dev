...
import img3 from "../../public/branchs.png";
  ...
  return (
    <div className="bg-white min-h-screen max-w-full mx-auto">
      ...
      <header className="px-4 py-3 flex items-center">
        <button className="mr-4 text-[#557860]">
          <ArrowLeft size={24} className="text-foreground" />
        </button>
        <h1 className="text-4xl font-bold text-[#557860]">Branch</h1>
      </header>
      ...
      <div className="relative bg-gradient-to-br from-teal-800 to-teal-600 text-white rounded-xl shadow-xl w-[350px] overflow-hidden">
        ...
        <div className="relative p-4 text-center">
          ...
          <h2 className="text-teal-200 text-xs uppercase tracking-wider font-bold">Special Offer</h2>
          <h1 className="text-2xl font-extrabold mt-2 mb-3 text-shadow-lg">7-Day Free Trial Pass</h1>
        </div>
